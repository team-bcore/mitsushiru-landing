                    ...
                    <div>
                        <div className="p-8 bg-primary rounded">
                            ...
                            <ul className="mb-8 space-y-2">
                                ...
                                <li className="flex items-center">
                                    <p className="font-medium text-gray-700">※月次単位でご解約可能です。（月途中のご解約申し出は、月末付けで対応します）</p>
                                </li>
                            </ul>
                            <div>
                                <a
                        ...
                        <div className="p-8 bg-primary rounded">
                            ...
                            <ul className="mb-8 space-y-2">
                                ...
                                <li className="flex items-center">
                                    ...
                                    <p className="font-medium text-gray-700">※ご利用1年未満でご解約の場合、解約違約金が発生します。（レンタル機材はご返却頂きます）</p>
                                </li>
                            </ul>
                            <div>
                                <a
