                ...
                <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                        <span class="relative inline-block">
                            ...
                            <span class="relative">料金プラン</span>
                        </span>{' '}

                    </h2>
                    <p class="text-base text-gray-700 md:text-lg">
                        ミツシルは月額10,000円からご利用できます。<br></br>機材は購入かレンタルをお選びいただけます。
                    </p>
                </div>
                <div class="grid max-w-screen-md gap-10 md:grid-cols-2 sm:mx-auto">
                    <div>
                        <div class="p-8 bg-primary rounded">
                            <div class="mb-4 text-center">
                                ...
                                <div class="flex items-center justify-center">
                                    ...
                                    <p class="text-lg text-gray-500">/ 月</p>
                                </div>
                            </div>
                            <ul class="mb-8 space-y-2">
                                ...
                                <li class="flex items-center">
                                    ...
                                    <p class="font-medium text-gray-500">税抜価格</p>
                                </li>
                                <li class="flex items-center">
                                    <p class="font-medium text-gray-500">※月次単位でご解約可能です。（月途中のご解約申し出は、月末付けで対応します）</p>
                                </li>
                        ...
                        <div class="w-11/12 h-2 mx-auto bg-primary rounded-b opacity-75" />
                        <div class="w-10/12 h-2 mx-auto bg-primary rounded-b opacity-50" />
                        <div class="w-9/12 h-2 mx-auto bg-primary rounded-b opacity-25" />
                    </div>
                    <div>
                        <div class="p-8 bg-primary rounded">
                            <div class="mb-4 text-center">
                            ...
                            <ul class="mb-8 space-y-2">
                                ...
                                <li class="flex items-center">
                                    ...
                                    <p class="font-medium text-gray-500">※ご利用1年未満でご解約の場合、解約違約金が発生します。（レンタル機材はご返却頂きます）</p>
                                </li>
