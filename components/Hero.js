  ...
  return (
    <div className="bg-hero-pattern bg-no-repeat bg-cover">
      <div className="container mx-auto h-screen flex flex-col justify-evenly">
        <div className="">
          <h1 className="text-center text-3xl font-bold text-gray-900 md:text-5xl md: xl:text-6xl">
            密になりにくい<br></br>安心な空間に変えていく
          </h1>
        </div>
        <div className="">
          <p className="text-center text-xl p-4 leading-relaxed text-gray-700 sm:mx-10 md:mx-46 md:px-40 lg:mx-32 xl:mx-80 2xl:mx-96">
            密集度モニターシステム
          </p>
        </div>
        <div className="">
          <p className="text-center p-4 leading-relaxed text-gray-700 sm:mx-10 md:mx-46 md:px-40 lg:mx-32 xl:mx-80 2xl:mx-96">
            新型コロナウイルスの感染が拡大する中で<br></br>
            「密を避けて利用をしたい」<br></br>「密な施設には行かない」<br></br>
            という施設利用者の意識が高まっています。<br></br>
            <br></br>ミツシルは施設を利用する側と管理する側<br></br>
            両方の課題を解決するツールです。
          </p>
        </div>
      ...
      <div className="px-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6">
        <div className="md:px-3 lg:col-start-2 lg:col-end-4">
