                ...
                <div className="md:col-start-2 col-span-3">
                    <div className="p-4 text-center">
                        <Image
                            ...
                            alt="NO1"
                        />
                        <h5 className="p-1 text-center text-2xl font-semibold text-gray-900 mb-2 md:text-lg">シンプルな仕組み</h5>
                        <Image
                ...
                <div className="md:col-start-5 col-span-3">
                    <div class="p-4 text-center">
                        <Image
                            ...
                            alt="NO2"
                        />
                        <h5 className="p-1 text-center text-2xl font-semibold mb-2 text-gray-900 md:text-lg">低コスト</h5>
                        <Image
                ...
                <div className="md:col-start-8 col-span-3">
                    <div className="p-4 text-center">
                        <Image
                            ...
                            alt="NO3"
                        />
                        <h5 className="p-1 text-center text-2xl font-semibold mb-2 text-gray-900 md:text-lg">プライバシー保護</h5>
                        <Image
