...
export default function Features() {
    return (
        <div className="bg-secondary pt-20 pb-16">
            ...
            <div className="pt-8 grid grid-cols-1 md:grid-cols-11 gap-6">
                <div className="md:col-start-2 col-span-3">
                    ...
                    <Image
                            ...
                            alt="NO1"
                        />
                    <h5 className="p-1 text-center text-xl font-semibold mb-2 md:text-lg">シンプルな仕組み</h5>
                        <Image
                ...
                <div class="p-4 text-center">
                    <Image
                            ...
                            alt="NO2"
                        />
                    <h5 className="p-1 text-center text-xl font-semibold mb-2 md:text-lg">低コスト</h5>
                        <Image
                        ...
                        <div className="">                           
                            <p class="mb-4 text-left">
                            月額1万円からサービスを利用できるので、コストを抑えながら、お客様に安心して施設を利用していただけます。<br></br>
                ...
                <div className="p-4 text-center">
                    <Image
                            ...
                            alt="NO3"
                        />
                    <h5 className="p-1 text-center text-xl font-semibold mb-2 md:text-lg">プライバシー保護</h5>
                        <Image
