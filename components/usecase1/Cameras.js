...
export default function Cameras() {
  return (
    <div className="px-4py-24 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-28">
      <div className="flex flex-col w-full mb-6 lg:justify-between lg:flex-row md:mb-8">
        <div className="flex items-center mb-5 md:mb-6 group lg:max-w-xl">
          <a className="mr-3">
            <div className="flex items-center justify-center w-16 h-16 rounded-full bg-primary"></div>
          </a>
          <h2 className="font-noto text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl">
      ...
      <div className="grid gap-8 row-gap-5 mb-8 lg:grid-cols-3 lg:row-gap-8">
        <div>
          ...
          <p className="text-gray-700 font-ud">医科のカメラ設置状況</p>
        </div>
        <div>
          <Image
            className="rounded shadow-xl"
          ...
          />
          <p className="mb-2 text-xl font-bold leading-none sm:text-2xl"></p>
          <p className="text-gray-700 font-ud">パナソニックのAIカメラ「ビューレカ」</p>
        </div>
        <div>
          <Image
            className="rounded shadow-xl"
          ...
          />
          <p className="mb-2 text-xl font-bold leading-none sm:text-2xl"></p>
          <p className="text-gray-700 font-ud">歯科のカメラ設置状況</p>
        </div>
        <div>
          <Image
            className="rounded shadow-xl"
          ...
          />
          <p className="mb-2 text-xl font-bold leading-none sm:text-2xl"></p>
          <p className="text-gray-700 font-ud">医科待合室</p>
        </div>
        <div>
          <Image
            className="rounded shadow-xl"
        ...
        <div>
          ...
          />
          <p className="mb-2 text-xl font-bold leading-none sm:text-2xl"></p>
          <p className="text-gray-700 font-ud">歯科待合室</p>
        </div>
      </div>
    </div>
  );
