  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="mb-10 md:mx-auto sm:text-center md:mb-12">
        <h2 className="mb-6 font-noto text-3xl font-bold leading-none  text-gray-900 sm:text-4xl md:mx-auto">
      ...
      <div className="grid max-w-screen-lg gap-8 row-gap-5 md:row-gap-8 sm:mx-auto lg:grid-cols-2">
        <div className="transition duration-300 transform bg-white rounded md:text-center">
          ...
          <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
            <h5 className="font-ud mb-2 text-base leading-none">
        ...
        <div className="transition duration-300 transform bg-white rounded shadow-sm md:text-center">
          ...
          <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
            <h5 className="mb-2 font-ud text-base leading-none">
              歯科待合室 1日の時系列 人数推移（8時～20時）
            </h5>
          </div>
        </div>
      </div>
      <p className="font-ud leading-relaxed text-gray-700 mx-auto pt-12 grid lg:grid-cols-1 lg:px-24 xl:grid-cols-1 xl:px-48">
